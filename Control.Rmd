...
Git notes: 
Push locally:
git status #show what needs to pushed bc it was modified
git add 'filename' #use . for everything in the folder, this stages
git commit -m "comment" #commits it to the local repo
...
Analysis notes:
TO DO: Quantification needs up take
...
TO DO: Adjust and rerun with real (not just holder) cell counts for the AOA
...
TO DO: change beta-Glutamic acid name (from Beta_GlutamicAcid), make sure it gets quantified in all the cultures and all the field samples
TO DO: make sure all the AOA get 
